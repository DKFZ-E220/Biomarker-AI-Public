...
input_files <- c(
  "deg_FaDu_FaDu_RCT_20GY_vs_FaDu_Untreated.csv","deg_FaDu_FaDu_RT_20GY_vs_FaDu_Untreated.csv","deg_SAS_SAS_RCT_20GY_vs_SAS_Untreated.csv","deg_SAS_SAS_RT_20GY_vs_SAS_Untreated.csv","deg_UDSCC2_UDSCC2_RCT_20GY_vs_UDSCC2_Untreated.csv","deg_UDSCC2_UDSCC2_RT_20GY_vs_UDSCC2_Untreated.csv","deg_UPCI154_UPCI154_RCT_20GY_vs_UPCI154_Untreated.csv","deg_UPCI154_UPCI154_RT_20GY_vs_UPCI154_Untreated.csv"
)
...
# code with enriched and dendoplot but still the text sizes need to be changed
...
#create dotplots and enrichplots, here i have ignored the enrichplots for now 
```{r echo=TRUE}
...
# List of input files (replace with your actual file names)
input_files <- c("significant degs treated_lfc1.5.csv", "significant degs untreated_lfc1.5.csv")
